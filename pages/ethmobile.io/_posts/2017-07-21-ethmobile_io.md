...
5. Ouvrir l'index.html présent, rectifier l'intérieur des balises (meta title, h1) et modifier le chemin qui associe le fichier data_[...].js en conséquence (ligne 105)
