var contributors1 = httpGetAsync('https://api.github.com/users/ethmobile/repos', function(response) {
	...
	var contributors2 = httpGetAsync('https://api.github.com/repos/ethmobile/ethdroid/commits', function(response) {
	...
	var contributors3 = httpGetAsync('https://api.github.com/repos/ethmobile/ethdroid/stats/contributors', function(response) {
