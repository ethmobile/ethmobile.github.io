var contributors1 = httpGetAsync('https://api.github.com/users/ethmobile/repos', function(response) {
	...
	var contributors2 = httpGetAsync('https://api.github.com/repos/ethmobile/nom_du_projet/commits', function(response) {
	...
	var contributors3 = httpGetAsync('https://api.github.com/repos/ethmobile/nom_du_projet/stats/contributors', function(response) {
